...
function modifyStartButtonHolder(startButton: HTMLButtonElement, autoSolveButton: HTMLButtonElement): void {
...
function copyStyleSheet(oldSelector: string, newSelector: string, copiedStylesElement: HTMLStyleElement, sheet: CSSStyleSheet): void {
    try {
...
function copyRule(oldSelector: string, newSelector: string, copiedStylesElement: HTMLStyleElement, rule: unknown): void {
